...
const Settings = () => {
  ...
  return (
    <div className="w-full max-w-md md:max-w-2xl mx-auto h-screen bg-slate-100 flex flex-col font-sans overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto p-8 text-slate-700">
        <div className="bg-white p-4 rounded-xl shadow-sm mb-4">Edit Profile</div>
        <div className="bg-white p-4 rounded-xl shadow-sm mb-4">Notification Preferences</div>
        <div className="bg-white p-4 rounded-xl shadow-sm text-red-600">Logout</div>
      </main>
      <nav className="flex-none bg-white border-t flex justify-around p-3 shadow-lg">
